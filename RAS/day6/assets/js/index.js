...
function showMessages(messages, pageNum) {
  ...
  switch (type) {
    case "table":
      ...
      x.setAttribute("id", "messageTable");
      x.setAttribute("class", "col-lg-12");
      document.getElementById("messagesContainer").appendChild(x);
      
      y = x.insertRow(0);
      y.setAttribute("id", "headRow");
      
      h1 = document.createElement("TH");
      h2 = document.createElement("TH");
      h3 = document.createElement("TH");
      
      h1.setAttribute("class", "col-lg-6");
      h2.setAttribute("class", "col-lg-4");
      h3.setAttribute("class", "col-lg-2");
      
      t1 = document.createTextNode("Message");
      t2 = document.createTextNode("Author");
      t3 = document.createTextNode("Actions");
